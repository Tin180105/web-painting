    ...
    <body> 
        ...
        <div class="section-4">
            ...
            <div class="inner-wrap">
                <?php
                require_once('./db/conn.php');
                $newsExists = mysqli_query($conn, "SHOW TABLES LIKE 'news'");

                if ($newsExists && mysqli_num_rows($newsExists) > 0) {
                ...
                <?php 
                    ...
                    $fallbackNews = [
                        [
                            'title' => 'Giới thiệu tranh sơn dầu cao cấp',
                            'description' => 'Khám phá nghệ thuật tạo hình tinh tế, mang lại vẻ đẹp cổ điển và cảm hứng sống động cho không gian của bạn.',
                            'avatar' => 'assets/images/blog-1.jpg'
                        ],
                        [
                            'title' => 'Cách chọn tranh phù hợp không gian',
                            'description' => 'Lựa chọn kích thước, màu sắc và phong cách tranh để hợp với căn nhà, văn phòng hoặc góc làm việc của bạn.',
                            'avatar' => 'assets/images/blog-2.jpg'
                        ],
                        [
                            'title' => 'Hướng dẫn bảo quản tranh nghệ thuật',
                            'description' => 'Giữ tranh luôn đẹp lâu dài với cách treo, vệ sinh và lưu trữ đúng chuẩn, tránh ánh nắng trực tiếp và độ ẩm.',
                            'avatar' => 'assets/images/blog-3.jpg'
                        ]
                    ];

                    foreach ($fallbackNews as $post) {
                ?>
                <div class="blog-item">
                    <a href="#">
                        <div class="inner-image">
                        ...
                        <div class="inner-content">
                            <div class="inner-tag">Thông tin</div>
                            <h3 class="inner-title"><?=$post['title']?></h3>
                            <p class="inner-desc"><?=$post['description']?></p>
                        </div>
                    </a>
                </div>
                <?php
